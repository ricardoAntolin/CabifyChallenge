...
class NavigationIconClickListener @JvmOverloads internal constructor(
    private val context: Context, private val sheet: View, private val interpolator: TimeInterpolator? = null,
    ...
    override fun onClick(view: View) {
        ...
        val translateY = height - context.resources.getDimensionPixelSize(R.dimen.product_list_reveal_height)
