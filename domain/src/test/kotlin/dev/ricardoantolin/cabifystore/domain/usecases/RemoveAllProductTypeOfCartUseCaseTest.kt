...
class RemoveAllProductTypeOfCartUseCaseTest {
    private lateinit var removeAllProductTypeOfCartUseCase: RemoveAllProductTypeOfCartUseCase
    ...
    @Before
    fun setUp() {
        removeAllProductTypeOfCartUseCase = RemoveAllProductTypeOfCartUseCase(
            cartRepository,
            postExecutionThread
        )
    }
    ...
    fun should_call_repository_when_execute() {
        ...
        removeAllProductTypeOfCartUseCase.execute(product)
            .test()
            .assertNoErrors()
